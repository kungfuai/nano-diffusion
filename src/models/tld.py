...
https://github.com/apapiu/transformer_latent_diffusion/blob/main/tld/denoiser.py
"""
...
class MHAttention(nn.Module):
    ...
    def forward(self, q, k, v, attn_mask=None):
        ...
        # print(f"bs: {q.shape[0]}, n: {q.shape[1]}, h: {self.n_heads}")
...
class Denoiser(nn.Module):
    ...
    def forward(self, t, x, y=None, *args, **kwargs):
        if t.ndim == 0:
            ...
            t = t[:, None].float()
        t = self.fourier_feats(t).unsqueeze(1)
